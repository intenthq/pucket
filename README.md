...
**Thrift support**:
```
"com.intenthq.pucket" %% "pucket-thrift" % "1.0.3"
```

**Avro support**:
```
"com.intenthq.pucket" %% "pucket-avro" % "1.0.3"
```

**Spark connectors**:
```
"com.intenthq.pucket" %% "pucket-spark" % "1.0.3"
```

**MapReduce integration**:
```
"com.intenthq.pucket" %% "pucket-mapreduce" % "1.0.3"
```
